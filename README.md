...
## Welcome
Welcome to my projects written in Python3, with a few projects written in bash.
...
4. 4. [0x03-python-data_structures](./0x03-python-data_structures)
...
## Credits
Work is owned and maintained by Geofrey Kweyu.
